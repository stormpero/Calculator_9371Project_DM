...
vector <int>MUL_Nk_N(vector<int> N, vector<int> k); //Умножить натуральное число на 10^k // Чиганов Даниил город Санкт-Петербург страна Россия район Невский Первый парень на деревне Мамин программист Поглатитель бабушкиных пирожков
...
vector<int> MUL_ND_N(vector<int> entry, int number); //Умножение целого на цифру //Игoрян
